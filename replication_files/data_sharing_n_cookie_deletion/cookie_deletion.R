# =============================================================================
# cookie_deletion_checks_narrow_down.R   (replication_files pipeline version)
#
...
#
#   SECTION 3  Browsing-time heterogeneity (mirror of 2.2-2.7)
#     3.2 ... 3.7                                           -> fig:time_by_* (+ _log_status)
#
...
#   source("replication_files/data_sharing_n_cookie_deletion/cookie_deletion_checks_narrow_down.R")
# =============================================================================
...
# =============================================================================
# PLOT HELPERS (one consistent style for the 16 figures)
# =============================================================================
...
q_time[, grp := factor(grp_raw, levels = paste0("Q", 1:5))]
ggsave(paste0(FIGURES_DIR, "time_heterogeneity_by_user_quintile.pdf"),
       plot_coef(q_time, "vertical", TIME_LAB, QUINT_LAB), width = FIG_W, height = FIG_H_QUINT)
...
cat("Saved: 16 figures to", FIGURES_DIR, "\n")
